  ...
  return (
    <div className='bg-[#0e0e0e] pb-44 mobile:max-lg:pb-16'>
        <div className='flex mobile:max-lg:flex-col mobile:max-lg:h-[1100px] h-[700px]'>
            ...
            <div className='w-1/2 mobile:max-lg:hidden flex flex-col text-white font-light gap-7 justify-center items-center -translate-x-[505px] xl:-translate-x-[575px]'>
                ...
                <div className='text-start translate-x-64 leading-10'>
                    <p className='text-[18px]'>The Purpose of the hackathon is to bridge the gap between theory and practice. Many early career professionals know how to code, design, or manage but haven't yet worked in a fast-paced, cross-functional team environment where real products are built. By participating you will:</p>
                </div>

                <div className='flex text-start translate-x-64 leading-7 gap-4'>
                    <img className='w-16' src={whitearrow} alt="" />
                    <p>Collaborate with developers, designers and product managers in a balanced team.</p>
                </div>

                <div className='flex text-start translate-x-60 leading-7 xl:translate-x-60 gap-4'>
                    <img className='w-16' src={whitearrow} alt="" />
                    <p>Experience the full life cycle of product development from concept to delivery.</p>
                </div>

                <div className='flex text-start translate-x-60 leading-7 gap-4'>
                    <img className='w-16' src={whitearrow} alt="" />
                    <p>Learn to manage time, prioritize features and work with real world constraints.</p>
                </div>

                <div className='flex text-start translate-x-56 leading-7 gap-4'>
                    <img className='w-16' src={whitearrow} alt="" />
                    <p>Build portfolio worthy experience to showcase to employers and clients.</p>
                </div>
            </div>
        </div>
        ...
        <img
            src={reasonbg}
            alt=""
            className="h-[500px] mobile:max-lg:hidden xl:h-[600px] absolute -translate-y-[260px] xl:-translate-y-[290px] object-contain z-20 pointer-events-none"
        />
    </div>
  )
}
