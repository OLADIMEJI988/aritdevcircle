...
export default function Offer() {
  ...
  return (
    <div
      ref={ref}
      className="antialiased relative overflow-hidden mobile:max-lg:pt-20 lg:pt-16 w-full mobile:max-lg:pb-28 lg:pb-20 mobile:max-lg:h-full bg-[#0E0E0E] inter"
    >
      ...
      <div className="absolute top-20 tracking-wide left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center text-center w-full">
        ...
        >
          ...
          <span className="mobile:max-md:hidden">Different ?</span>
        </motion.p>
      ...
      <div className="flex justify-center mobile:max-lg:mt-[95px] lg:mt-[100px] gap-4 text-white mobile:max-lg:px-[20px] lg:px-[4vw] xl:px-[9vw]">
        ...
        >
          ...
          <p className="tracking-wide text-sm leading-7">
            Helping members improve the skills that actually move their careers
            forward
          </p>
        </motion.div>
        ...
        <div className="w-full mobile:max-lg:mx-[2vw] xsm:max-lg:gap-4 xsm:max-lg:grid mobile:max-md:grid-cols-1 md:max-lg:grid-cols-2">
          ...
          >
            <EachOffer
              ...
              subtext=" Helping members improve the skills that actually move their careers forward"
            />
          </motion.div>
          ...
          >
            <EachOffer
              ...
              subtext="Access to free & paid guidance from seasoned tech professionals."
            />
          </motion.div>
          ...
          >
            <EachOffer
              icon={chain}
              title="Hands On Challenges & Hackathons"
              subtext="Real projects that sharpen problem solving, teamwork, and portfolio building."
            />
          </motion.div>
          ...
          >
            <EachOffer
              icon={globe}
              title="A hub for diverse tech fields"
              subtext="Collaborate and network with developers, designers, PMs, data pros, writers, VAs, and more."
            />
          </motion.div>
        </div>
      </div>
