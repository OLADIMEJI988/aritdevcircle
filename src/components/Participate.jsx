  ...
  return (
    <>
       ...
       <div className='bg-[#0e0e0e] pb-10 mobile:max-lg:pt-3 pt-[480px] xl:pt-[540px]'>
           <img className='absolute right-0 mt-28 xl:-mt-32 h-full object-contain z-0' src={subtleglow} alt="" />
            <div className="flex mobile:max-lg:flex-col h-[700px] mobile:max-lg:h-auto">
                ...
                <div className='lg:hidden mx-[13px] mobile:max-lg:-mt-3 z-20'>
                    <CtaCards img= {boyincirclemobile} role="Developer" subtext="Gain real engineering experience" ctatext="Apply as dev" link="https://forms.gle/KQL8Jx6qf89Xtart9" />
                    <div className='my-6'>
                        <CtaCards img= {girlincirclemobile} role="Designer" subtext="Practice UI/UX in live collaboration" ctatext="Apply as designer" link="https://forms.gle/VC3ydM9DeYqp6tWd8" />
                    </div>
                    <CtaCards img= {manincirclemobile} role="Product or Product Managers " subtext="Shapen vision, planning & leadership skills" ctatext="Apply as PM" link="https://forms.gle/TczgYJCTJf4MF6Jh6"  />

                    <div className='flex flex-col mt-6 mb-10 justify-center items-center bg-[#1A1A1A] rounded-xl pt-6 pb-10 text-white'>
                        <p className='text-[19px] mx-5 leading-9 font-light tracking-wide mb-2 mt-4'>Irrespective of your role, all participant will walk away with new skills, new connections and a real sense of what it feels like to ship software as a product.</p>
                ...
                <div className="w-1/2 mobile:max-lg:hidden flex flex-col gap-11 justify-center items-center -translate-x-40">
                    ...
                    <div className="bg-[#282828] justify-between text-white text-start py-10 rounded-xl flex items-center h-10 -translate-x-16 w-[950px] pr-10">
                        <div className='flex items-center'>
                            ...
                            <div>
                                <p className="tracking-wide font-semibold text-[18px]">Developers</p>
                                <p className='mt-1 font-light text-[14px] tracking-wide'>Gain real engineering experience.</p>
                            </div>
                        </div>

                        <button className='px-7 font-semibold hover:shadow-[0_0_10px_#FF4F76] transition py-2 rounded-full bg-[#FF4F76]' onClick={() => window.location.href = "https://forms.gle/KQL8Jx6qf89Xtart9"}>Apply as dev</button>
                    </div>
                    ...
                    <div className="bg-[#282828] justify-between text-white text-start py-10 rounded-xl flex items-center h-10 -translate-x-12 w-[920px] pr-10">
                        <div className='flex items-center'>
                            ...
                            <div>
                                <p className="tracking-wide font-semibold text-[18px]">Designers</p>
                                <p className='mt-1 font-light text-[14px] tracking-wide'>Practice UI/UX in live collaboration.</p>
                            </div>
                        </div>

                        <button className='px-7 font-semibold hover:shadow-[0_0_10px_#FF4F76] transition py-2 rounded-full bg-[#FF4F76]' onClick={() => window.location.href = "https://forms.gle/VC3ydM9DeYqp6tWd8"}>Apply as designer</button>
                    </div>
                    ...
                    <div className="bg-[#282828] justify-between text-white text-start py-10 rounded-xl flex items-center h-10 -translate-x-8 w-[890px] pr-10">
                        <div className='flex items-center'>
                            ...
                            <div>
                                <p className="tracking-wide font-semibold text-[18px]">Product or Product Managers</p>
                                <p className='mt-1 font-light text-[14px] tracking-wide'>Sharpen vision, planning & leadership skills.</p>
                            </div>
                        </div>

                        <button className='px-7 hover:shadow-[0_0_10px_#FF4F76] transition font-semibold py-2 rounded-full bg-[#FF4F76]' onClick={() => window.location.href = "https://forms.gle/TczgYJCTJf4MF6Jh6"}>Apply as PM</button>
                    </div>
                    ...
                    <div className='bg-[#282828] justify-between text-white text-start py-10 rounded-xl flex items-center h-10 -translate-x-5 w-[870px] px-10'>
                       <div>
                            <p className="tracking-wide font-light text-[14px]">Irrespective of your role, all participant will walk away with new skills, new </p>
                            <p className='mt-1 font-light text-[14px] tracking-wide'>connections and a real sense of what it feels like to ship software as a product.</p>
                       </div>
