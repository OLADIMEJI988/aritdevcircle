...
export default function AwardsAndRegRework() {
  return (
    <div className="bg-[#0e0e0e] pt-10 xl:pt-[90px] gap-3 pb-14 flex flex-col justify-center items-center">
        ...
        >
          ...
          <div className="relative tracking-wide justify-center text-2xl py-20 leading-tight z-10 flex flex-col h-full">
            <p className="text-white text-[25px] font-semibold">
              Awards & <span className="text-[#FF4F76]">Recognition</span>
            </p>
            <p className="text-white text-[16px] leading-8 mt-7 px-10">
        ...
        >
          ...
          <div className="relative tracking-wide justify-center text-2xl py-20 leading-tight z-10 flex flex-col h-full">
            <p className="text-white text-[26px] font-semibold">
              Project Evaluation <span className="text-[#FF4F76]">Basis</span>
            </p>
            <p className="text-white text-[16px] leading-8 mt-7 mb-2 px-2">
              Note: Projects will be evaluated base on
            </p>
            <p className="text-white text-[16px] flex leading-8 px-5">
              <span className="font-bold -mt-[5px] mr-[5px]">.</span>{" "}
              Functionality and feature completion
            </p>
            <p className="text-white text-[16px] flex leading-8 px-5">
              <span className="font-bold -mt-[5px] mr-[5px]">.</span> User
              experience and design quality
            </p>
            <p className="text-white text-[16px] flex leading-8 px-5">
              <span className="font-bold -mt-[5px] mr-[5px]">.</span> Code
              quality and documentation
            </p>
            <p className="text-white text-[16px] flex leading-8 px-5">
              <span className="font-bold -mt-[5px] mr-[5px]">.</span> Team
      ...
      <img
        className="absolute right-0 mt-14 mobile:max-lg:mt-[370px] h-full object-contain pointer-events-none"
        src={awardglow}
        alt=""
      />
