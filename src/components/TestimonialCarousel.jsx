...
export default function TestimonialCarousel() {
  ...
  return (
    <div className="flex flex-col items-center pt-10 mobile:max-lg:pb-[500px] lg:pb-20 justify-center bg-[#0E0E0E] text-white overflow-hidden relative">

        <div className="mobile:max-xxm:text-[35px] px-[15px] xxm:max-xsm:text-3xl xsm:text-4xl font-semibold inter mb-10">
            <p>Hear What Our <span className="text-[#FA3E67] xxm:max-wsm:hidden">Community Members</span></p>
            <span className="text-[#FA3E67] mobile:max-xxm:hidden wsm:hidden">Community Members</span>
          ...
          return (
            <AnimatePresence key={t.id}>
              <motion.div
                ...
                } rounded-[45px] px-7 py-6 shadow-xl relative flex flex-col items-center text-center mobile:max-xsm:w-[345px] xsm:w-[480px] h-[320px]`}
              >
                <img
                  src={t.img}
                  alt={t.name}
                ...
                />
                <p className="text-sm leading-relaxed line-clamp-6">{t.text}</p>
